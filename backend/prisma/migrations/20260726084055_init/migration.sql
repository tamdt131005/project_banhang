...
CREATE TABLE `products` (
    ...
    INDEX `products_isActive_createdAt_idx`(`isActive`, `createdAt`),
...
CREATE TABLE `orders` (
    ...
    `paymentMethod` ENUM('COD', 'MOMO') NOT NULL DEFAULT 'COD',
    ...
    `shippingWard` VARCHAR(120) NOT NULL,
    `shippingDistrict` VARCHAR(120) NOT NULL,
    `shippingProvince` VARCHAR(120) NOT NULL,
